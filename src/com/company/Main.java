...
public class Main {
    ...
    final static String DIR_SRC = ROOT_DIR + "/src";
    final static String DIR_RES = ROOT_DIR + "/res";
    final static String DIR_SAVE = ROOT_DIR + "/savegames";
    final static String DIR_TEMP = ROOT_DIR + "/temp";
    static StringBuilder log = new StringBuilder();

    public static void  main(String[] args) {

        crDirPrintResult(DIR_SRC);
        crDirPrintResult(DIR_RES);
        crDirPrintResult(DIR_SAVE);
        crDirPrintResult(DIR_TEMP);

        crDirPrintResult(DIR_SRC + "/main");
        crDirPrintResult(DIR_SRC + "/test");

        crFilePrintResult(DIR_SRC + "/main/Main.java");
        crFilePrintResult(DIR_SRC + "/main/Utils.java");

        crDirPrintResult(DIR_RES + "/drawables");
        crDirPrintResult(DIR_RES + "/vectors");
        crDirPrintResult(DIR_RES + "/icons");

        String path = DIR_TEMP + "/temp.txt";
